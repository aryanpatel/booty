 ...
 * @package Booty
 * @since booty 1.0
 * @todo customize this for more post type support
 */

if ( ! class_exists( 'booty_Related_Portfolios' ) ) :

class booty_Related_Portfolios {
    ...
    function __construct(){
        ...
        $this->supported_post_types = array( 'portfolio' );
    ...
    function related_add_metabox( $post_type ) {
        if ( in_array( $post_type, $this->supported_post_types ) ) {
            add_meta_box(
                'related-metabox',
                esc_html__( 'Related Portfolio', BOOTY_TXT_DOMAIN ),
