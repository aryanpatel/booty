        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="holder">
                        <!-- icon list -->
                        <?php if (isset($config['layout_creative_option_e_near_nav']) && $config['layout_creative_option_e_near_nav'] == 'show'): ?>
                            <ul class="list-unstyled icon-list">
                                <?php if (isset($config['layout_creative_option_e_near_nav_language']) && $config['layout_creative_option_e_near_nav_language'] == 'show'): ?>
                                    <li>
                                        <?php echo booty_language_dropdown('type_1'); ?>
                                    </li>
                                <?php endif; ?>
                                <?php if (isset($config['layout_creative_option_e_near_nav_cart']) && $config['layout_creative_option_e_near_nav_cart'] == 'show'): ?>
                                    <li class="cart-box">
