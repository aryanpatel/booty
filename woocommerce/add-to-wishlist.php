...
<div class="yith-wcwl-add-to-wishlist add-to-wishlist-<?php echo $product_id ?> btn-add">
	<?php if( ! ( $disable_wishlist && ! is_user_logged_in() ) ): ?>
	    ...
	    <div class="yith-wcwl-wishlistaddedbrowse hide" style="display:none;">
	        <a href="<?php echo esc_url( $wishlist_url )?>" rel="nofollow">
	            <i class="fa fa-heart-o"></i><?php echo esc_html__( 'BROWSE WISHLIST', BOOTY_TXT_DOMAIN ); ?>
	        </a>
	    </div>
	...
	<?php else: ?>
		<a href="<?php echo esc_url( add_query_arg( array( 'wishlist_notice' => 'true', 'add_to_wishlist' => $product_id ), get_permalink( wc_get_page_id( 'myaccount' ) ) ) )?>" rel="nofollow" class="<?php echo str_replace( 'add_to_wishlist', '', $link_classes ) ?>" >
			<i class="fa fa-heart-o"></i><?php echo esc_html__( 'ADD TO WISHLIST', BOOTY_TXT_DOMAIN ); ?>
		</a>
	<?php endif; ?>
